	  ...
	  var test1 = "";
        $.ajax({
			...
			//$('#orders-list tbody').append(xml);
			   ...
			   $('#orders-list tbody').append("<tr><td style='widtd:180px;'><a href='<?php echo base_url()?>index.php/welcome/order_view/"+orderNumber+"'>"+orderNumber+"</a></td><td style='widtd:200px;'>"+d.getDate()+"-"+d.getMonth()+"-"+d.getFullYear()+"</td><td style='widtd:150px;'>84546585</td><td style='widtd:150px;'>"+d.getDate()+"-"+d.getMonth()+"-"+d.getFullYear()+"</td><td style='widtd:150px;'>$ "+invoice_amount+"</td><td style='widtd:150px;'>"+ship_city+" / "+ship_state+"</td><td style='widtd:100px;'>Open</td></tr>");
                 //datatables();           
		   });
