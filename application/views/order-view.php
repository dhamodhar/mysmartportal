                ...
                <div class="page page-shop-single-order">
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="order-view.php" class="sub-active">Order View</a>
                                </li>
                            </ul>
                    ...
                    <div class="pagecontent">
                        ...
                        <div class="add-nav">
                            ...
                            <h3>Order : <strong class="text-greensea">665932-001</strong></h3>
                            ...
                            <div role="tabpanel">
                                ...
                                <ul role="tablist" class="nav nav-tabs">
                                    <li class="active" role="presentation"><a data-toggle="tab" role="tab" aria-controls="details" href="#">My Account</a></li>
                                    <li role="presentation"><a data-toggle="tab" role="tab" aria-controls="invoices" href="#">My Catalog</a></li>
                                    <li role="presentation"><a data-toggle="tab" role="tab" aria-controls="payments" href="#">Order History</a></li>
                                                        ...
                                                        <div class="row b-t pt-20">
                                                            ...
                                                            <div class="col-md-3 b-r" id="order_details">
                                                                ...
                                                                <ul class="list-unstyled text-default lt mb-20">
                                                                    ...
                                                                    <li><strong>Dube Date : </strong> </li>
                                                                    <li><strong>Pay Type : </strong> On Account</li>
                                                                    <li><strong>Tracking : </strong> 84546585</li>
                                                                </ul>
                                                            </div>
                                                            <!-- /col -->
